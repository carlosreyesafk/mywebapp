	...
	if ( ! class_exists( 'FusionSC_Faq' ) && class_exists( 'Fusion_Element' ) ) {
		...
		class FusionSC_Faq extends Fusion_Element {
			...
			public function query( $defaults ) {
				...
				if ( ! empty( $defaults['offset'] ) ) {
					$args['offset'] = (int) $defaults['offset'];
				}
			...
			public function render( $args, $content = '' ) {
				...
				$this->args      = FusionBuilder::set_shortcode_defaults( $this->defaults, $args, 'fusion_faq' );
		...
		fusion_builder_frontend_data(
			...
			[
				...
				'params'       => [
					...
					[
						'type'        => 'range',
						'heading'     => esc_attr__( 'FAQ Offset', 'fusion-core' ),
						'description' => esc_attr__( 'The number of FAQ posts to skip. ex: 1.', 'fusion-core' ),
						'param_name'  => 'offset',
						'value'       => '0',
						'min'         => '0',
						'max'         => '25',

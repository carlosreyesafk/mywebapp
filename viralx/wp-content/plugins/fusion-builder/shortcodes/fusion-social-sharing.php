		...
		class FusionSC_SharingBox extends Fusion_Element {
			...
			public function render( $args, $content = '' ) {
				...
				if ( 'brand' === $this->args['color_type'] ) {
					...
					$social_icon_boxed_colors['copy_link'] = [
						'label' => esc_attr__( 'Copy Link', 'fusion-builder' ),
						'color' => '#333333',
					];
				}
			...
			public function icon_link_attr( $args ) {
				...
				if ( 'copy_link' === $args['social_network'] ) {
 					$attr['onclick'] = 'copyPageUrl(event)';
				} else {
			...
			public function icon_attr( $args ) {
				...
				if ( 'email' === $args['social_network'] ) {
					$args['social_network'] = 'mail';
				} else if ( 'copy_link' === $args['social_network'] ) {
					$args['social_network'] = 'share';
				}
						...
						'fields'      => [
							'social_sharing'             => [
								...
								'choices'                => [
									...
									'copy_link' => esc_html__( 'Copy Link', 'fusion-builder' ),
								],

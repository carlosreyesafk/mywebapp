...
if ( ! class_exists( 'Fusion_Builder_Front' ) ) {
	...
	class Fusion_Builder_Front {
		...
		public function load_templates() {
			...
			include FUSION_BUILDER_PLUGIN_DIR . 'front-end/templates/awb-dd.php';
			include FUSION_BUILDER_PLUGIN_DIR . 'front-end/templates/awb-text-path.php';
			...
			include FUSION_BUILDER_PLUGIN_DIR . 'front-end/templates/form-components/turnstile.php';
		...
		public function live_scripts() {
			...
			if ( ( ! defined( 'FUSION_BUILDER_DEV_MODE' ) || ! FUSION_BUILDER_DEV_MODE ) && ( ! defined( 'SCRIPT_DEBUG' ) || ! SCRIPT_DEBUG ) ) {
				...
				wp_enqueue_script( 'fusion_builder_dynamic_data_element', FUSION_BUILDER_PLUGIN_URL . 'front-end/views/elements/view-awb-dd.js', [], FUSION_BUILDER_VERSION, true );

				wp_enqueue_script( 'fusion_builder_text_path_element', FUSION_BUILDER_PLUGIN_URL . 'front-end/views/elements/view-awb-text-path.js', [], FUSION_BUILDER_VERSION, true );
				...
				wp_enqueue_script( 'fusion_builder_form_turnstile', FUSION_BUILDER_PLUGIN_URL . 'front-end/views/form/view-turnstile.js', [], FUSION_BUILDER_VERSION, true );
...
function fusion_element_front_options_loop( $params ) {
	...
	function fusion_display_option( param ) {
		...
		hasDynamic      = 'object' === typeof atts.dynamic_params && 'undefined' !== typeof atts.dynamic_params[ param.param_name ] && ! Array.isArray( atts.dynamic_params[ param.param_name ] ) && supportsDynamic;
				...
				<div class="option-details-inner">
					<# if ( 'undefined' !== typeof param.heading ) { #>
						...
						<ul class="fusion-panel-options">
							...
							<# if ( supportsDynamic ) { #>
								<li><a class="option-dynamic-content" href="JavaScript:void(0);" aria-label="<?php esc_attr_e( 'Dynamic Data', 'fusion-builder' ); ?>"><i class="fusiona-dynamic-data" aria-hidden="true"></i></a><span class="fusion-elements-option-tooltip fusion-tooltip-preview"><?php esc_html_e( 'Dynamic Data', 'fusion-builder' ); ?></span></li>
							<# } #>

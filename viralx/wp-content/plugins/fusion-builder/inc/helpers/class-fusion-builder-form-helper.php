		...
		$params = [
			[
				...
				'value'       => [
					...
					'username'             => esc_attr__( 'Username', 'fusion-builder' ),
					'new-password'         => esc_attr__( 'New Password', 'fusion-builder' ),
					'current-password'     => esc_attr__( 'Current Password', 'fusion-builder' ),
